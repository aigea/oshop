...
export class AuthService {
  ...
  constructor(private afAuth: AngularFireAuth, private route: ActivatedRoute, private router: Router, private userService: UserService) {
    ...
    this.user$ = afAuth.authState; // Not subscribing the observable here, instead we will conver it into App User Observable below
  }
  ...
  get appUser$(): Observable<AppUser> {
    // uid is the property of the 'user' object and is the user represented by firebase as part of authentication and not the user object stored in the database
